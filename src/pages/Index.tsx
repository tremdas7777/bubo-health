...
const PRICE_COMBO_3_KIT = DEFAULT_COMBO_3_KIT_PRICE;
const COMPARE_COMBO_3_KIT = roundMoney(PRICE_COMBO_3_KIT * STRIKE_RATIO_SINGLE_POTE);
const PRICE_COMBO_FULL_KIT = DEFAULT_COMBO_4_KIT_PRICE;
const COMPARE_COMBO_FULL_KIT = STRIKE_PRICE_COMBO_4;
