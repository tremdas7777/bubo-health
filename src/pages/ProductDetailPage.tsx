...
import { Minus, Plus, Truck, Shield, ShieldCheck, Package, Wrench, Gauge, Flame, Ruler, Zap, CircuitBoard, CheckCircle2, Star, HelpCircle, Gift, Check, ShoppingCart } from "lucide-react";
...
`,
  ...
  const formatPrice = (decimal: number) => fmt(decimal);
